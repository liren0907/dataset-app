        ...
        <div class="max-w-xl w-full bg-white rounded-lg shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div class="px-6 py-4 overflow-y-auto">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="extractSourceDir" value={sourceDir} readonly class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-500" />
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 mb-1" for="extractOutputDir">Output Directory</label>
                    <div class="flex gap-2">
                        <input type="text" id="extractOutputDir" bind:value={settings.outputDir} readonly placeholder="Select directory for extracted files..." class="flex-1 px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-500" />
                ...
                <div>
                    <span class="block text-sm font-medium text-gray-700 mb-2">Labels to Extract (check to include)</span>
            ...
            <div class="px-6 py-4 border-t bg-gray-50 flex justify-end space-x-2 mt-auto">
                ...
                <button
                    ...
                    onclick={() => onextract?.()}
                    disabled={loading || !settings.outputDir || selectedLabels.size === 0}
                >
                    {#if loading}
